...
thread1 is forwarding info to victim from gateway
thread2 is forwarding info to gw from victim
...
def ArpSpoofer(victim_ip, seconds_to_run):
    ...
    ### find gatewayIP ###
    default_gateway_ip = Gateway_IP_finder()
