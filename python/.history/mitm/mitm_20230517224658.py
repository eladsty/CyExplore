...
# def gateway2victim_handler(packet,default_gateway_mac,gw_ip ,attack_mac , victim_mac , victim_ip):
...
#         gateway2victim_handler(packet, default_gateway_mac, gw_ip ,attack_mac , victim_mac , victim_ip),\
